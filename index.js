...
// Calculate the Total number of months included in the dataset 
  // Add in a console.log to count how many months are in the dataset 
// Calculate the total amount of profit / losses over the entire period
  // Target array within an array 
  // Add in a variable to target the numbers in each array 
  // console.log to add all the variable that targets only the integer values within the array 
// Average of the changes in profit/losses
  // Track the total change in profit/losses from month to month 
  // find the average
...
const financialValues = finances.map(entry => entry[1])
